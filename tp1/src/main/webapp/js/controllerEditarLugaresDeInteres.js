app.controller('EditarLugaresDeInteresCtrl', function($resource, Pais,PaisAEditar, $state,$timeout, $stateParams) {
    ...
    this.addSeleccion= function(){
    	self.paisEditando.get.lugares.push(self.lugarAAgregar);
    }
...
app.controller('NuevosLugaresDeInteresCtrl', function($resource, Pais,PaisNuevo, $state,$timeout, $stateParams) {
